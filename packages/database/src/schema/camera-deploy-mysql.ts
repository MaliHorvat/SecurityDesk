...
export const cameraDeploySession = mysqlTable(
  "camera_deploy_session",
  {
    ...
    status: mysqlEnum("status", ["draft", "planned", "deploying", "completed", "cancelled"])
      .notNull()
      .default("draft"),
...
export const cameraDeployTarget = mysqlTable(
  "camera_deploy_target",
  {
    ...
    status: mysqlEnum("status", ["pending", "configured", "deployed", "failed", "skipped"])
      .notNull()
      .default("pending"),
