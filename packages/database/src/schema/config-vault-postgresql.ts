...
import { device } from "./securitydesk-postgresql";

export const configurationBackup = pgTable(
  "configuration_backup",
  {
    ...
    lastCheckedByUserId: varchar("last_checked_by_user_id", { length: 36 }).references(() => user.id, {
      onDelete: "set null",
    }),
